...
SELECT
  ...
  SUM(DisturbanceSoftProduction    * (cohort_proportion)) +
  SUM(DisturbanceHardProduction    * (cohort_proportion)) AS DisturbanceProduction,
  ...
  SUM(DisturbanceSWStemSnagToAir   * (cohort_proportion)) +
  SUM(DisturbanceHWStemSnagToAir   * (cohort_proportion)) AS DisturbanceStemSnagToAir,
  SUM(DisturbanceSWBranchSnagToAir * (cohort_proportion)) +
  SUM(DisturbanceHWBranchSnagToAir * (cohort_proportion)) AS DisturbanceBranchSnagToAir
