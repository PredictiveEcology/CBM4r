...
Most functions will read `cbm4_data` into a `SQLResultsProcessor` object as the first step,
so calling `cbm4_results_processor` directly is more efficient when reading more than one result.
