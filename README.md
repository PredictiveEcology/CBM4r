...
Spatial datasets are created with an additional "pixels" table with metadata about the study area pixels. This table has columns `pixel_index`, `chunk_index`, `raster_index`, `x`, `y`, `area`.
